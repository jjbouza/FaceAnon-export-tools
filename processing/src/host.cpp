...
int main(){
    ...
    // test postprocessing
    std::vector<torch::Tensor> olist = {torch::ones({1,2,112,112}), torch::ones({1,4,112,112}), 
                                        torch::ones({1,2,56,56}), torch::ones({1,4,56,56}),
                                        torch::ones({1,2,56,56}), torch::ones({1,4,56,56}),
                                        torch::ones({1,2,56,56}), torch::ones({1,4,56,56}),
                                        torch::ones({1,2,9,9}), torch::ones({1,4,9,9}),
                                        torch::ones({1,2,5,5}), torch::ones({1,4,5,5})};
